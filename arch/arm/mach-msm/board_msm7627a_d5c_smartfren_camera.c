...
//static int camera_gpio_rear_qrd7[] = {93, 23, 30};//PWDN, RESET, DRIVER_PWDN  //delete by hanjue
...
static struct camera_vreg_t ov8825_truly_cm8313_gpio_vreg[] = {
   {"cam_ov8825_truly_cm8313_avdd", REG_GPIO, 0, 0, 0},
   {"cam_ov8825_truly_cm8313_vdd", REG_GPIO, 0, 0, 0},
};
#endif
//add by hanjue 2012.12.25
...
#endif
//static struct msm_camera_sensor_info msm_camera_sensor_s5k4e1_data;   //delete by hanjue
...
//add by hanjue 2012.12.25
#ifdef CONFIG_OV8825_TRULY_CM8313
static struct msm_camera_gpio_conf gpio_conf_ov8825_truly_cm8313 = {
   .camera_off_table = camera_off_gpio_table,
   .camera_on_table = camera_on_gpio_table,
   .gpio_no_mux = 1,
};

static struct msm_camera_sensor_flash_src msm_flash_src_ov8825_truly_cm8313 = {
   .flash_sr_type = MSM_CAMERA_FLASH_SRC_LED1,
   ._fsrc.ext_driver_src.led_en = 32,
   ._fsrc.ext_driver_src.led_flash_en = 13,
};

static struct msm_camera_sensor_flash_data flash_ov8825_truly_cm8313 = {
   .flash_type     = MSM_CAMERA_FLASH_LED,
   .flash_src      = &msm_flash_src_ov8825_truly_cm8313,
};

static struct msm_camera_sensor_platform_info sensor_board_info_ov8825_truly_cm8313 = {
   .mount_angle  = MOUNT_ANGLE_NOT_CONFIGURED,
   .cam_vreg = msm_cam_vreg,
   .num_vreg = ARRAY_SIZE(msm_cam_vreg),
   .gpio_conf = &gpio_conf_ov8825_truly_cm8313,
};
...
static struct msm_camera_sensor_info msm_camera_sensor_ov8825_truly_cm8313_data = {
   .sensor_name    = "ov8825_truly_cm8313",
   .sensor_reset_enable    = 1,
   .pmic_gpio_enable = 1,
   .sensor_reset           = GPIO_NOT_CONFIGURED,
   .sensor_pwd     = GPIO_NOT_CONFIGURED,
   .pdata  = &msm_camera_device_data_csi1[1],
   .flash_data     = &flash_ov8825_truly_cm8313,
   .sensor_platform_info = &sensor_board_info_ov8825_truly_cm8313,
   .csi_if = 1,
   .camera_type = BACK_CAMERA_2D,
   .sensor_type = BAYER_SENSOR,
   .actuator_info = &msm_act_main_cam_3_info,
...
//add by hanjue 2012.12.25
#ifdef CONFIG_OV8825_TRULY_CM8313
sensor_board_info_ov8825_truly_cm8313.cam_vreg = NULL;
sensor_board_info_ov8825_truly_cm8313.num_vreg = 0;
#endif
//add by hanjue 2012.12.22
//add by hanjue 2012.12.22
#ifdef CONFIG_GC0339
           sensor_board_info_gc0339.cam_vreg = NULL;
           sensor_board_info_gc0339.num_vreg = 0;
#endif
//add by hanjue 2012.12.22
   ...
   else if(machine_is_msm8625_qrd5() || machine_is_msm7x27a_qrd5a())
   {
       ...
       msm_camera_sensor_ov8825_data.sensor_reset = GPIO_SKU3_CAM_5MP_CAMIF_RESET;
       msm_camera_sensor_ov8825_data.sensor_pwd = GPIO_SKU3_CAM_5MP_SHDN_N;
       sensor_board_info_ov8825.mount_angle = 270;  //modify by hanjue
#endif

//add by hanjue 2012.12.25
#ifdef CONFIG_OV8825_TRULY_CM8313
sensor_board_info_ov8825_truly_cm8313.cam_vreg = ov8825_truly_cm8313_gpio_vreg;
       sensor_board_info_ov8825_truly_cm8313.num_vreg = ARRAY_SIZE(ov8825_truly_cm8313_gpio_vreg);
       msm_act_main_cam_3_info.vcm_pwd = GPIO_SKU3_CAM_5MP_CAM_DRIVER_PWDN;
       msm_act_main_cam_3_info.vcm_enable = 0;
       msm_camera_sensor_ov8825_truly_cm8313_data.sensor_reset = GPIO_SKU3_CAM_5MP_CAMIF_RESET;
       msm_camera_sensor_ov8825_truly_cm8313_data.sensor_pwd = GPIO_SKU3_CAM_5MP_SHDN_N;
       sensor_board_info_ov8825_truly_cm8313.mount_angle = 90;  //modify by hanjue
...
#ifdef CONFIG_GC0339
       sensor_board_info_gc0339.cam_vreg = gc0339_gpio_vreg;
       sensor_board_info_gc0339.num_vreg = ARRAY_SIZE(gc0339_gpio_vreg);
...
//add by hanjue 2012.12.22
   ...
   if (machine_is_msm8625_surf() || machine_is_msm8625_evb()
           ...
           || machine_is_msm8625_qrd7() || machine_is_msm8625q_skud()) {
...
#ifdef CONFIG_OV8825_TRULY_CM8313
    {
       I2C_BOARD_INFO("ov8825_truly_cm8313", 0x6C >> 3),
       .platform_data = &msm_camera_sensor_ov8825_truly_cm8313_data,
   },
...
static void d9_camera_gpio_cfg(void)
{
   ...
   rc = gpio_request(GPIO_SKU3_CAM_5MP_CAMIF_RESET, "ov8825_truly_cm8313");
   if (rc < 0)
       pr_err("%s: gpio_request ov8825_truly_cm8313 sensor_reset: %d failed!",
            __func__, GPIO_SKU3_CAM_5MP_CAMIF_RESET);
   ...
   rc = gpio_request(GPIO_SKU1_CAM_VGA_SHDN, "gc0339");
       ...
       rc = gpio_tlmm_config(GPIO_CFG(GPIO_SKU1_CAM_VGA_SHDN, 0,
           ...
           GPIO_CFG_2MA), GPIO_CFG_ENABLE);
       if (rc < 0) {
           pr_err("%s:unable to enable Powr wdn gpio for frnt camera!\n",
                __func__);
       ...
       rc = gpio_request(GPIO_SKU1_CAM_VGA_RESET_N, "gc0339");
       if (rc < 0)
...
void __init msm7627a_camera_init(void)
{
   ...
   d9_camera_gpio_cfg();//add by hanjue
   }else if(machine_is_msm8625q_skud())
   {
