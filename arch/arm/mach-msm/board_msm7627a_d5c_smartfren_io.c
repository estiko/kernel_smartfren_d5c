...
static unsigned int kp_row_gpios_8625[] = {31,34};
static unsigned int kp_col_gpios_8625[] = {36, 37,38, 42};
static unsigned int kp_row_gpios_8625_qrd5[] = {31, 34};
#define KP_INDEX_D9(row, col) ((row)*ARRAY_SIZE(kp_col_gpios_8625) + (col))
//add by hanjue 2012.12.25
...
#endif
//add by hanjue
[KP_INDEX_D9(0, 0)] = KEY_VOLUMEUP, \
[KP_INDEX_D9(0, 1)] = KEY_VOLUMEDOWN,  \
[KP_INDEX_D9(1, 2)] = KEY_CAMERA_FOCUS, \
[KP_INDEX_D9(1, 3)] = KEY_CAMERA,
...
//#define LED_GPIO_PDM 96          //linxc 2012-12-21 ---

#define MAX_VKEY_LEN       100

#if 0  //linxc 2012-12-21 ---
...
//#add by linxc for D9 Himax Touch Screen
#ifdef CONFIG_TOUCHSCREEN_HIMAX        

#define HIMAX_MULTITOUCH_INT_GPIO 48  //D9: GPIO48-->CAP_TS_INT_N

static struct i2c_board_info himax_ts_i2c_info[] __initdata = {
   {   
       I2C_BOARD_INFO("himax_ts", 0x90 >> 1),   //himax hx8527a
       .irq = MSM_GPIO_TO_INT(HIMAX_MULTITOUCH_INT_GPIO),
   },
};
#endif
...
#define LED_FLASH_EN1 32  //13  modiy by hanjue
